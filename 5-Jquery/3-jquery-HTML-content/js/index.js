$(function () {
    ...
    $('#btn1').click(function (e) {
        e.preventDefault();
        let message = $('#someDiv>p').text() //get the paragrapf on the alert
        alert(message)
    ...
    $('#btn2').click(function (e) {
        e.preventDefault();
        $('#someDiv>h2').text('Hello FBW5'); //change the title on a click event
    ...
    $('#btn4').click(function (e) {
        e.preventDefault();
        let message=$('#someDiv>p').html('I am <strong>strong</strong>');
        alert(message)
    });
