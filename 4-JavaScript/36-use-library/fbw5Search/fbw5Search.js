...
function appInit(containerId,apiKey) {
    ...
    if (appContainer) {
        ...
        btn1.addEventListener('click',function (e) {
            ...
            getData(inp1.value,div2,paggingDiv,1,colorList,orientationList,categoryList,minWidthInput,minHeightInput,apiKey)
...
async function getData(keyWord,imagesContainer,paggingContainer,pageNumber,colorListElement,
    orientationListElement,categoryListElement,minWidthElement,minHeightElement,key) {
    ...
    let url = 'https://pixabay.com/api/?key='+key+'&q='+keyWord + '&page=' +pageNumber+ colorParameter + orientationParameter + categoryParameter +minWidthParameter + minHeighthParameter
