window.onload=function () {
    ...
    let myFunction = function () { //the errow function make problem with jquery and internet explorer
        
        ctx.clearRect(boxCounter + 20, 79, 20, 20) //should reduce the last one
        ctx.fillRect(boxCounter, 79, 20, 20)
        if (boxCounter == 0) {
            boxCounter = 580
        } else {
